...
- (instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        [cancelBtn setTitleColor:MKCOLOR_RGB(251, 93, 96) forState:UIControlStateNormal];
        ...
        [questionBtn setTitleColor:MKCOLOR_RGB(251, 93, 96) forState:UIControlStateNormal];
