...
- (void)setupUI{
    ...
    //底部 固定View
    UIImageView *imgView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"mjb_LaunchScreen"]];
    ...
    UIImageView *imgView2 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"app_start_img"]];
