...
- (void)initWithNoDataViewWithStr:(NSString*)str onView:(UIView*)view{
    [self initWithNoDataViewWithStr:str labColor:MKCOLOR_RGB(251, 93, 96) imgName:nil onView:view];
}
...
- (void)initWithNoDataViewWithStr:(NSString *)str labColor:(UIColor*)labColor imgName:(NSString*)imgName button:(NSString *)btnTitle onView:(UIView *)view{
   ...
   self.viewWithNoData = [UIHelper noDataViewWithTitle:labStr titleColor:labColor image:imgName ? imgName : imgName button:btnTitle];
    ...
    //无信号
    self.viewWithNoNetwork = [UIHelper noDataViewWithTitle:@"啊噢,网络不见了" image:imgName];
...
- (void)initWithNoDataViewWithLabColor:(UIColor*)labColor imgName:(NSString*)imgName onView:(UIView *)view strArgs:(NSString *)arg1,... NS_REQUIRES_NIL_TERMINATION{
    ...
    self.viewWithNoData = [UIHelper noDataViewWithTitleArr:strArr titleColor:labColor image:imgName ? imgName : imgName button:nil];
