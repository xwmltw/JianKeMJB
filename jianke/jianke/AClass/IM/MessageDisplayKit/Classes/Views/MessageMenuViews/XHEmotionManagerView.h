...
#define kXHEmotionPerRowItemCount (kIsiPad ? 15 : 7)
#define kXHEmotionPageControlHeight 28
//#define kXHEmotionSectionBarHeight 42
#define kXHEmotionSectionBarHeight 0

#define EmotionRowCount  (kIsiPad ? 4 : 4)
#define EmotionPageCount (EmotionRowCount * kXHEmotionPerRowItemCount)
 ...
 *点击下面那一排按钮，现在主要是发送按钮
 */
- (void)didSelecteEmotionBar:(NSInteger)section;
