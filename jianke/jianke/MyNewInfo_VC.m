...
//    [array1 addObject:@(MyInfoJKCellType_MyNewInfo)];
    [array1 addObject:@(MyInfoJKCellType_MySign)];
    [array1 addObject:@(MyInfoJKCellType_WhoLookMe)];
    [array1 addObject:@(MyInfoJKCellType_MyIntertion)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (cellType) {
        ...
        case MyInfoJKCellType_MySign:
        case MyInfoJKCellType_WhoLookMe:
        case MyInfoJKCellType_MyIntertion:
