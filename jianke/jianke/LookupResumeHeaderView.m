...
- (void)setupViews{
    ...
    UIButton *btnLeft = [UIButton buttonWithTitle:@"0次完工" bgColor:MKCOLOR_RGB(220, 81, 84) image:nil target:self sector:@selector(btnOnClick:)];
    ...
    UIButton *btnRight = [UIButton buttonWithTitle:@"0次放鸽子" bgColor:MKCOLOR_RGB(220, 81, 84) image:nil target:self sector:@selector(btnOnClick:)];
