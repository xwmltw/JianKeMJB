...
- (UIView *)getTableHeaderView{
    ...
    [mutablAttStr addAttributes:@{NSForegroundColorAttributeName: MKCOLOR_RGB(251, 93, 96)} range:NSRangeFromString(@"@{1, 5}")];
...
//        title = @"请主动联系商家，按照以下联系方式与商家沟通，获取工作内容";
    ...
    UIView *viewNodata = [UIHelper noDataViewWithTitleArr:@[@"报名成功", title] titleColor:MKCOLOR_RGB(251, 93, 96) image:nil button:nil];
    viewNodata.y = 89;
