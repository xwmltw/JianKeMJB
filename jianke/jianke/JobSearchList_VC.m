...
//        _tfSearch.placeholder = @"输入雇主、岗位关键词搜索";
        ...
        _tfSearch.backgroundColor = MKCOLOR_RGB(220, 81, 84);
        _tfSearch.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"输入雇主、岗位关键词搜索" attributes:@{NSFontAttributeName: [UIFont systemFontOfSize:13.0f], NSForegroundColorAttributeName : MKCOLOR_RGBA(255, 255, 255, 1)}];
