...
- (void)setup{
    ...
    [self setTitleColor:MKCOLOR_RGBA(34, 58, 80, 0.48) forState:UIControlStateNormal];
...
- (void)layoutSubviews{
    ...
    // 图片位置
    CGFloat imageX = (self.width - imageW) * 0.125;
    CGFloat imageY = (self.height - imageH  - kmarginBetweenImgAndTitle) * 0.5;
    
    // 标题位置
    CGFloat titleX = (imageX + imageW) + 12;
    CGFloat titleY = imageH/2 + imageY - titleH/2;
