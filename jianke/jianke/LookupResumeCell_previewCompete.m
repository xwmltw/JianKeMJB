...
- (void)setModel:(JKModel *)model{
    ...
    NSMutableAttributedString *mutableAttStr = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%ld", model.complete_work_num.integerValue] attributes:@{NSFontAttributeName: [UIFont systemFontOfSize:26.0f], NSForegroundColorAttributeName: MKCOLOR_RGB(251, 93, 96), NSBaselineOffsetAttributeName: @0}];
