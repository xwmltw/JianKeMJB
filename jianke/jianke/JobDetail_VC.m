...
@interface JobDetail_VC ()<UITableViewDelegate, UITableViewDataSource, UIAlertViewDelegate, UIActionSheetDelegate, JobDetailFooterViewDelegate,UMSocialUIDelegate>{
        ...
        case JDCellType_welfare:
        {
            ...
            switch (sectionType) {
                ...
                case JDCellType_time:{
                    ...
                    cell.labTitle.text = timeRangeStr;
                }
                    break;
...
- (XHPopMenu *)epPopMenu{
    if (!_epPopMenu) {
        XHPopMenuItem *popMenuCloseItem1 = [[XHPopMenuItem alloc] initWithImage:nil title:@"置顶岗位"];
        XHPopMenuItem *popMenuCloseItem2 = [[XHPopMenuItem alloc] initWithImage:nil title:@"刷新岗位"];
        XHPopMenuItem *popMenuCloseItem3 = [[XHPopMenuItem alloc] initWithImage:nil title:@"分享岗位"];
        XHPopMenuItem *popMenuCloseItem4 = [[XHPopMenuItem alloc] initWithImage:nil title:@"结束招聘"];
        XHPopMenu *epPopMenu = [[XHPopMenu alloc] initWithMenus:@[popMenuCloseItem1, popMenuCloseItem2, popMenuCloseItem3, popMenuCloseItem4]];
